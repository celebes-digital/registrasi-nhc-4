...
<?php if (!session()->info) : ?>
	...
	<div class="form-group">
		<label for="kelas">Kelas <span class="required-field">*</span></label>
		<input type="text" name="kelas" id="kelas" value="<?= old('kelas'); ?>"
			class="form-control <?= validation_show_error('kelas') ? 'is-invalid' : ''; ?>"
	...
	<div class="form-group d-none" id="lainnyaGroup">
		<label for="lainnyaInput">Sebutkan sumber informasi <span class="required-field">*</span></label>
		<input type="text" name="lainnyaInput" id="lainnyaInput"
			class="form-control <?= validation_show_error('lainnyaInput') ? 'is-invalid' : ''; ?>"
			placeholder="Masukkan informasi lainnya">
		<div class="invalid-feedback"><?= validation_show_error('lainnyaInput'); ?></div>
	</div>
