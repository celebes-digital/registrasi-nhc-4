...
<head>
	...
	<title>NHC BATCH 4</title>
	<meta name="description" content="Ngoding Holiday Camp adalah tempat belajar coding yang menyenangkan untuk anak-anak dan remaja. Nikmati liburan penuh ilmu dan kreativitas sambil membuat proyek coding yang seru!">
	<meta name="keywords" content="Ngoding Holiday Camp, belajar coding, coding untuk anak-anak, liburan coding, HTML, CSS, JavaScript, belajar pemrograman, desain antarmuka, program edukatif">
	...
	<footer id="contact" class="footer">
		<div class="footer-top">
			...
			<div class="footer-contact">
				<p><strong>Phone:</strong> 082292877750</p>
			</div>
			<h4>Follow Us</h4>
			<p>Jadilah yang pertama tahu! Temukan inspirasi, tips, dan update terbaru hanya dengan mengikuti kami.</p>
			<div class="social-links">
				<a href="https://www.facebook.com/celebesdigital"><i class="bi bi-facebook"></i> </a>
				<a href="https://www.instagram.com/celebesdigital_id/"><i class="bi bi-instagram"></i></a>
				<a href="https://www.tiktok.com/@celebesdigital"><i class="bi bi-tiktok"></i> </a>
				<a href="https://www.youtube.com/@celebesdigital"><i class="bi bi-youtube"></i> </a>
			</div>
		</div>
